...
All notable changes for RTI Oracle should be recorded in this file.

## [Unreleased]

### Changed
- Packaging output executable is now renamed to `OracleByFPC_v<version>.exe`.
- Packaging docs now include PowerShell-specific troubleshooting and required staging verification.
