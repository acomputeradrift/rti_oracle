...
public sealed class ProjectDataExtractionResult
{
    ...
    public ProjectData.Models.ProjectDataBundle ToBundle()
    {
        return ProjectData.Models.ProjectDataBundle.FromExtractionResult(this);
    }
}
...
public interface IProjectDataExtractor
{
    ...
    ProjectData.Models.ProjectDataBundle ExtractBundle(string apexPath, IProgress<ProjectDataExtractionProgress>? progress = null);
}
...
public sealed class ProjectDataExtractor : IProjectDataExtractor
{
    ...
    public ProjectData.Models.ProjectDataBundle ExtractBundle(string apexPath, IProgress<ProjectDataExtractionProgress>? progress = null)
    {
        var result = Extract(apexPath, progress);
        return ProjectData.Models.ProjectDataBundle.FromExtractionResult(result);
    }
